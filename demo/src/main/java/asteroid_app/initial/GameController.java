...
public class GameController {
    ...
    public void play(Pane pane, Scene mainScene){
        ...
        alienShip.move(pane, ship, asteroids);
            ...
            bullets.forEach(bullet -> {
                ...
                if (!bullet.getAlive()) {
                    if (System.currentTimeMillis() - GameMenu.lastAddedTime > (500)) {
                        Main.score.incrementScoreForAsteroid(asteroid.getInitialSize());
                        GameMenu.scoreText.setText("Points: " + Main.score.getScore());
                        if(Main.score.getScore()>=Main.newLifeScore && Main.playerLives.getLives() < 2){
                            Main.playerLives.gainLife();
                            Main.score.incrementScore(-Main.newLifeScore); 
                            GameMenu.scoreText.setText("Points: " + Main.score.getScore());
                        }
        ...
        GameMenu.PlayerLivesText.setText("Lives: " + Main.playerLives.getLives());
